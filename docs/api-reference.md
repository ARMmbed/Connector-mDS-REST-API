...
Endpoints are physical devices running [mbed Client](https://www.mbed.com/en/development/software/mbed-client/). For more information about mbed Device Connector’s data model, see the [REST API introduction](/docs/v1.2/legacy-products/mbed-device-connector-web-api.html#the-mbed-device-connector-data-model).
...
#### Reading from a resource ([async](/docs/v1.2/legacy-products/mbed-device-connector-web-api.html#asynchronous-requests))
...
#### Writing to a resource ([async](/docs/v1.2/legacy-products/mbed-device-connector-web-api.html#asynchronous-requests))
...
The [mbed Client overview](/docs/v1.2/legacy-products/features.html) contains information on how to process updates on the device side.

#### Executing a function on a resource ([async](/docs/v1.2/legacy-products/mbed-device-connector-web-api.html#asynchronous-requests))
...
The [mbed Client overview](/docs/v1.2/legacy-products/features.html) contains information on how to handle the execute operation on the device side.

#### Deleting a resource ([async](/docs/v1.2/legacy-products/mbed-device-connector-web-api.html#asynchronous-requests))
...
The [mbed Client overview](/docs/v1.2/legacy-products/features.html#the-device-management-and-service-enabler-feature) contains information on how to handle the delete operation on the device side.
...
Whether or not a resource is observable is determined by [mbed Client](/docs/v1.2/legacy-products/features.html), not by mbed Device Connector.

#### Subscribing to an individual resource ([async](/docs/v1.2/legacy-products/mbed-device-connector-web-api.html#asynchronous-requests))
